...
#define NS4_OUT_DIRECTORY					u8"D:\\N64OST\\Donkey Kong 64\\"
#define NS4_OUT_DIRECTORY_NUMBERS			NS4_OUT_DIRECTORY u8"Numbered\\"
#define NS4_WET_FILTER_FREQ					0.0//(NS4_ORIG_HZ / 2.0)
#define NS4_VIB_SCALE						2.0
#define NS4_ENV_MULTIPLIER					(1.0 / 3.0)

{ u8"Donkey Kong 64 (E) 00000037 00118C3A.mid", u8"Donkey Kong 64 (E) 00000037 00118C3A.mid TrackParseDebug.txt", u8"Shipwreck Shanty (Gloomy Galleon)", 0 },

/*
* 
{ u8"Donkey Kong 64 (U) 000000A0 0014BBC0.mid", u8"Donkey Kong 64 (U) 000000A0 0014BBC0.mid TrackParseDebug.txt", u8"Jungle Japes Storm", 0,
	4 + 1 + 1, {
